...
const clubsSeed = [
  {
    ...
    manager: "Riya Shah",
    description: "Startup community for pitch practice, market research, and student venture building.",
  ...
  },
  {
    ...
    manager: "Arjun Verma",
    description: "Community focused on web development, UI/UX, DSA, and creative technologies.",
  ...
  },
  {
    ...
    manager: "Sara Khan",
    description: "Peer-led coding circles, DSA practice, contests, and interview preparation.",
  ...
  },
  {
    ...
    manager: "Devika Nair",
    description: "Communication lab for public speaking, leadership, interviews, and personal branding.",
  ...
  },
  {
    ...
    manager: "Manav Joshi",
    description: "Developer sessions on Android, Flutter, Firebase, Google Cloud, and AI tools.",
  ...
  },
  {
    ...
    description: "Design community for UX research, no-code prototypes, critiques, and product thinking.",
  ...
  },
  {
    ...
    description: "Vehicle design team exploring aerodynamics, CAD, telemetry, and F1-inspired builds.",
  ...
  },
  {
    ...
    manager: "Asha Menon",
    description: "Creative studio for photography, reels, motion graphics, and campus storytelling.",
  ...
  },
  {
    ...
    description: "Security community for CTFs, secure coding, ethical hacking, and awareness labs.",
...
const eventGroups = [
  ["College Events", [
    ["Pravaah", "A flagship cultural fest with singing, dance, theatre, fashion, and inter-department showcases.", "Cultural Fest", "Main Auditorium", 7, image("photo-1501386761578-eac5c94b800a")],
